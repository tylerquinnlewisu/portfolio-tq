        ...
        <div className="row">
          ...
          <a className="col_3" href="https://todolist-tq.azurewebsites.net/">
            <div className="portfolio_set target">
              ...
              <br />
              <a className='viewcode' href='https://github.com/tylerquinnlewisu/todolist-tq'>View Code</a>
            </div>
          </a>
          ...
          <a className="col_3" href="https://webdevquiz.azurewebsites.net/">
            <div className="portfolio_set target">
              ...
              <br />
              <a className='viewcode' href='https://github.com/tylerquinnlewisu/webdevquiz'>View Code</a>
            </div>
          </a>
          ...
          <a className="col_3" href="https://mango-ground-0c9924810.1.azurestaticapps.net/">
            <div className="portfolio_set target">
              ...
              <br />
              <a className='viewcode' href='https://github.com/tylerquinnlewisu/softwaresystemscapstoneteamthreeproject'>View Code</a>
            </div>
          </a>
